...
class ModuloController extends Controller
{
    ...
    {
        $data = [];
        return $this->render('admin/modulos/index', '', '', $data);
    }
    ...
    public function save(Request $request)
    {
        ...
        $modulo->loadData($request->getBody());

        // SE VALIDA LA INFORMACIÓN RECIBIDA
        $validacion = $modulo->validate();
        ...
        echo json_encode(['response' => true, 'message' => 'El módulo fue registrado exitosamente.']);
    }
}